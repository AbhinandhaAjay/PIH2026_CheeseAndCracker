...
{/* {incident.image_url ? (
  ...
  <div className="mt-4 text-gray-500 italic">No accident image available</div>
)} */}


          {/* Image with Zoom Icon */}
          <div
            className="relative mt-4 cursor-zoom-in"
    ...
    <div className="mt-6 bg-white border border-gray-200 rounded-lg overflow-hidden">
      ...
      <div className="divide-y divide-gray-200">
        ...
        {data.severity && (
          ...
          <h6 className="text-xl text-gray-800 mb-4"><br></br>Accident Location📌</h6>
      ...
      <div className="px-4 py-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            ...
            className="inline-flex justify-center items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-500 hover:bg-blue-700"
          >
...
const handleAcceptIncident = async (incidentId) => {
  ...
  try {
    ...
    setIncidents((prev) =>
      prev.map((i) => (i.id === id ? { ...i, hospital_status: "rejected" } : i))
    );
  } catch (err) {
  ...
  const pendingIncidents = incidents.filter((i) => i.hospital_status === "pending");
  const acceptedIncidents = incidents.filter((i) => i.hospital_status === "accepted");
  //const rejected = incidents.filter((i) => i.status === "rejected");
  const rejected = incidents.filter((i) => i.hospital_status === "rejected");
